...
from Domain.card_client_validator import \
    CardClientValidator
...
from Domain.rezervare_validator import \
    RezervareValidator
from Repository.card_client_repository import \
    CardClientRepository
from Repository.film_repository import FilmRepository
from Repository.rezervare_repository import \
    RezervareRepository
...
def test_rezervare_service():
    ...
    card_client_repository = CardClientRepository(
        filename2, [])
    film_repository = FilmRepository(filename3)
